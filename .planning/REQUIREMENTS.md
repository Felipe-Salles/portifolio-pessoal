...
- [ ] **SEC-01**: Site não carrega nenhuma origem externa de script/fonte/ícone (Tailwind, fontes e ícones compilados/self-hosted no build)
...
- Unmapped: 30 ⚠️ (resolved by roadmapper)
